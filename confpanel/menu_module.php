 ...
 <section id="container" >
      ...
      <header class="header black-bg">
            ...
            <!--logo start-->
            <a href="../../template.php" class="logo"><b>ToBagus | Admin Panel</b></a>
            <!--logo end-->
          ...
          <div id="sidebar"  class="nav-collapse ">
              ...
              <ul class="sidebar-menu" id="nav-accordion">
                  ...
                  <li class="sub-menu">
                    ...
                    }elseif (@$_GET['page'] OR @$_GET['pelayanandanproduk'] OR @$_GET['galeri'] OR @$_GET['promoproduk'] OR @$_GET['inbox']){
                        echo "<a class=\"active\" href=\"javascript:;\">";
                    }else{
                    ...
                    ?>
                      ...
                      if ($module=="promoproduk"){
                          echo " <li class=\"active\"><a  href=\"../../module/mod_promo/promo.php?tbl=promoproduk\">Tabel Promo</a></li>";
                         }else{
                          echo" <li><a  href=\"../../module/mod_promo/promo.php?tbl=promoproduk\">Tabel promo</a></li>";
                      }
