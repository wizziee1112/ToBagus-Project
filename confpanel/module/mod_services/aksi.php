...
if ($module == "add"){
    ...
    $tambah     = "INSERT INTO tbl_services (pict_services, title_services, description_services, harga, lang_services)
                  VALUES ('$pict_services', '$title_services', '$description_services', '$harga', '$lang_services')";
                  ...
                  <hr>
                    <form class=\"form-horizontal style-form\" action=\"../../module/mod_services/aksi.php?pelayanandanproduk=update&id_services=$showservices[id_services]\" method=\"POST\" enctype=\"multipart/form-data\">
                      <div class=\"form-group\">          
                          ...
                          <label class=\"col-sm-2 col-sm-2 control-label\">harga</label>
                          <div class=\"col-sm-10\">
                              <input type=\"text\" class=\"form-control\" name=\"harga\" value=\"$showservices[harga]\" oninvalid=\"alert('harga harus di isi !');\"required>
                          </div>
...
if ($module == "update"){
    ...
    $update       = "UPDATE tbl_services SET pict_services='$pict_services', title_services='$title_services', description_services='$description_services', harga='$harga', lang_services='$lang_services' where id_services='$id_services'";
