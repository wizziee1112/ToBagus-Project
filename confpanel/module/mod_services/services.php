            ...
            <div class=\"col-md-12\">
             <div class=\"content-panel\">
              <table class=\"table table-striped table-advance table-hover\">
                ...
                <hr>
                <a href=\"../../module/mod_services/aksi.php?pelayanandanproduk=add\"><button class=\"btn btn-success btn-xs\"><i class=\"fa fa-plus\"></i> Tambah</button></a>
                  <thead>
                  <tr>
                    <th><i class=\"\"></i> No</th>
...
$kalimat_services  = $data_services['harga'];  
echo"
                  <tr>
                    <td>$id_services</td>
